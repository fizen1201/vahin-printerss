...
Load the **Brainstorm Coach Agent** from `.claude/commands/waypoint/agents/brainstorm.md`.
...
_WayPoint Brainstorm command for unknown stack + Domain-Driven Design_
